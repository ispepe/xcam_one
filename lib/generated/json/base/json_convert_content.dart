...
import 'package:xcam_one/generated/json/iq_info_entity_helper.dart';
...
import 'package:xcam_one/generated/json/notify_status_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
			...
			case IQInfoFunction:
				return iQInfoFunctionFromJson(data as IQInfoFunction, json) as T;
			...
			case NotifyStatusEntity:
				return notifyStatusEntityFromJson(data as NotifyStatusEntity, json) as T;
			case NotifyStatusFunction:
				return notifyStatusFunctionFromJson(data as NotifyStatusFunction, json) as T;
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			case IQInfoEntity:
				return iQInfoEntityToJson(data as IQInfoEntity);
			case IQInfoFunction:
				return iQInfoFunctionToJson(data as IQInfoFunction);
			case DiskFreeSpaceEntity:
			...
			case NotifyStatusEntity:
				return notifyStatusEntityToJson(data as NotifyStatusEntity);
			case NotifyStatusFunction:
				return notifyStatusFunctionToJson(data as NotifyStatusFunction);
			case CameraFileListEntity:
